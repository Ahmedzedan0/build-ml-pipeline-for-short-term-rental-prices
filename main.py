    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "data_split" in active_steps:
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "random_seed": config["etl"]["random_seed"],
                    "stratify_by": config["etl"]["stratify_by"]
                },
            )
        ...
        if "train_random_forest" in active_steps:
            ...
            _ = mlflow.run(
                ...
                "main",
                parameters={
                    "trainval_artifact": "data/trainval_data.csv:latest",
        ...
        if "test_regression_model" in active_steps:
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "test_artifact": "data/test_data.csv:latest"
                }
            )
